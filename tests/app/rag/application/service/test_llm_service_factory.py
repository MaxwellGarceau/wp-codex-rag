...
class TestLLMServiceFactory:
    ...
    def test_init_with_multiple_clients(self):
        """Test LLMServiceFactory initialization with multiple clients."""
        mock_openai_client = Mock(spec=LLMClientInterface)
        mock_huggingface_client = Mock(spec=LLMClientInterface)
        factory = LLMServiceFactory(
            {
                LLMProvider.OPENAI: mock_openai_client,
        ...
        assert factory.clients[LLMProvider.OPENAI] == mock_openai_client
    ...
    def test_handle_embedding_with_extra_kwargs(self):
        ...
        result = self.factory._handle_embedding(
            self.mock_client, text="test text", extra_param="ignored"
        )
